...
terraform {
  ...
  backend "s3" {
    bucket  = "fiap-terraform-state-dev-arthur" # Bucket S3 para state
...
# Pipeline test Thu Jul 23 15:47:17 -03 2026
# Deploy test Thu Jul 23 16:27:48 -03 2026
# Deploy test Thu Jul 23 16:31:39 -03 2026
